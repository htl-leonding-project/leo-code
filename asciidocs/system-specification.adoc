...
Zu entwickeln ist ein Plattform welche:

* es ermöglicht Schülern Code-Beispiele zu programmieren (Java,C#)

* Schülern zu ihren Abgaben Feedback bzw. die Lösung bereitstellt
