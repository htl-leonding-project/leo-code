...
Nachdem der Schüler die Tests und Aufgaben absolviert hat, ist der Professor in der Lage es sich anzuschauen falls der Schüler es für den Lehrer veröffentlicht.
